  ...
  <div className="w-full h-full bg-white flex items-center justify-center overflow-hidden">
    ...
    <div className="relative">
      <div className="absolute inset-0 -z-10
        ...
        translate-y-5 scale-[0.95]" />
    </div>

    {/* iPhone Body (same size) */}
    <div className={`w-[34%] ${getMobilewidthClasses()} relative h-[98%] sm:h-[88%]
    ...
    `}>
      ...
      <div className="relative w-full h-full rounded-[1.4rem]
        ...
        <div className="relative w-full h-full bg-black rounded-[1.4rem] overflow-hidden">
          ...
          <video
            ...
            className={`w-full h-full object-cover scale-x-[1.1] scale-y-[1.12]
      ...
      {/* Side Buttons (same position, more depth) */}
