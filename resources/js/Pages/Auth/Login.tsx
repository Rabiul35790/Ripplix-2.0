                    ...
                    <div className="w-full max-w-md">
                        ...
                        {status && (
                            <div className="mb-4 sm:mb-6 md:mb-5 p-3 sm:p-4 md:p-3.5 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg">
                                <div className="text-xs sm:text-sm md:text-[13px] font-medium text-green-800 dark:text-green-200">
                                    {status}
                                </div>
                            </div>
                        )}
                        ...
                        <form onSubmit={submit} className="space-y-4 sm:space-y-5 md:space-y-4">
                            ...
                            <div className="flex items-center justify-between pt-1 sm:pt-2 md:pt-1">
                                <div className="flex items-center space-x-2">
                                    <Checkbox
                                        ...
                                        className="w-3.5 h-3.5 sm:w-4 sm:h-4 md:w-3.5 md:h-3.5 !text-[#2B235A] bg-white dark:bg-gray-800 border border-[#E3E2FF] dark:border-gray-600 rounded focus:outline-none focus:ring-0"
                                    />
                                    <label htmlFor="remember" className="text-xs sm:text-sm md:text-xs text-[#7F7F8A] dark:text-gray-400">
                                        Remember me
                                    </label>
                                </div>
                                {canResetPassword && (
                                    <Link
                                        ...
                                        className="text-xs sm:text-sm md:text-xs text-[#2B235A] hover:text-black dark:text-blue-400 dark:hover:text-blue-300 font-medium transition-colors duration-300 focus:outline-none focus:ring-0"
                                    >
                                        Forgot Password
                                    </Link>
                                )}
