...
const MemoizedLibraryCard = memo<{
  ...
  isBlurred?: boolean;
  currentPlatformFilter?: string;
}>(({ library, onLibraryClick, cardSize, auth, ziggy, onStarClick, userLibraryIds, viewedLibraryIds, onLibraryViewed, userPlanLimits, isBlurred = false, currentPlatformFilter }) => {
  return (
