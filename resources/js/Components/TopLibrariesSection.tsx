        ...
        <div className="relative w-full" style={{
          ...
          {libraryVideos.length > 0 ? (
            ...
            <div className="absolute inset-0 rounded-lg flex items-center justify-center bg-[#F5F5FA]">
              <Atom className="w-8 h-8 text-[#CECCFF]" />
            </div>
          )}
        </div>
      </div>
    ...
    <div className="mx-4 sm:mx-6 md:mx-8 lg:mx-14 mt-12 sm:mt-16 lg:mt-12 pb-8 sm:pb-10 lg:pb-12 space-y-12 sm:space-y-16 font-sora">
      ...
      {topLibrariesByCategory.length > 0 && (
        <div>
          <div className="flex items-start justify-between mb-6">
            <div className="flex items-start gap-3">
              <div className="w-10 h-10 rounded-lg bg-[#FFE7CD] flex items-center justify-center flex-shrink-0">
                <Command className="w-5 h-5 text-[#FFA31E]" />
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {topLibrariesByCategory.map((group, index) => (
      ...
      {topLibrariesByInteraction.length > 0 && (
        <div>
          <div className="flex items-start justify-between mb-6">
            <div className="flex items-start gap-3">
              <div className="w-10 h-10 rounded-lg bg-[#E8D2FC] flex items-center justify-center flex-shrink-0">
                <Star className="w-5 h-5 text-[#9943EE]" />
              </div>
              <div className="flex flex-col">
                <h2 className="text-xl lg:text-2xl font-bold text-[#2B235A] mb-2">
                  Top Elements
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {topLibrariesByInteraction.map((group, index) => (
      ...
      {topLibrariesByIndustry.length > 0 && (
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {topLibrariesByIndustry.map((group, index) => (
